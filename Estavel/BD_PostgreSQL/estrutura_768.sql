...
-- Adaptada para all-mpnet-base-v2 (768 dimensões)
-- =============================================================================
...
-- (Opcional) Exemplo de particionamento mensal
...
-- 4) Índices Vetoriais (768 dimensões)
...
-- 6) (Opcional) Dicionário de sinônimos
...
-- 8) Função Híbrida Avançada de Busca RAG
...
-- 9) Função Precise com filtro mínimo de cosseno
